...
export const VideoCard = memo(({ video, onDelete, onUpdate }) => {
  ...
  return (
    ...
    <>
      ...
      >
        {/* Video Link Area */}
        <Link to={`/video/${video._id}`} className="relative block overflow-hidden border-b-[4px] border-neoBlack aspect-video bg-black">
          <img
            src={video.thumbnail}
            alt={video.title}
        ...
        <div className="flex flex-1 gap-4 p-5">
          ...
          <div className="flex flex-col flex-1">
            ...
            <Link to={`/u/${video.owner?.username}`} className="mt-2 text-sm font-black tracking-wide text-gray-700 uppercase">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-80 backdrop-blur-sm">
          <div className="bg-neoWhite border-[6px] border-neoBlack shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] max-w-md w-full p-8 flex flex-col animate-in zoom-in-95">
             <h2 className="pb-2 mb-4 text-4xl font-black uppercase border-b-[4px] border-neoBlack text-[#ff0055]">Delete Video?</h2>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-80 backdrop-blur-sm">
          <div className="bg-neoWhite border-[6px] border-neoBlack shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] max-w-lg w-full p-8 flex flex-col animate-in zoom-in-95">
             <div className="flex items-center justify-between pb-4 mb-6 border-b-[4px] border-neoBlack">
               ...
               <button onClick={() => setShowEditModal(false)} className="p-1 transition-all border-[3px] border-transparent hover:rotate-90 hover:bg-[#ff0055] hover:text-white hover:border-black">
             ...
             <label className="mb-2 text-lg font-black uppercase">Description</label>
             <textarea 
